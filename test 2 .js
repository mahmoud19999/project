...
function displaylinks()
{
    ...
    {
    trs+='<tr><td>'+containers[i].names+'</td><td></td><td><a class="btn btn-primary" href=https://'+containers[i].webssites+'>Visit</a><button onclick="Deletelink('+i+')" class="btn btn-danger">Delete</button></td></tr>';
